...
public class JSWalaTaintAnalysis extends WalaTaintAnalysis {
	...
	protected AstSSAPropagationCallGraphBuilder makeBuilder(Collection<? extends Module> files, AnalysisConsumer server) throws WalaException {
		...
		AstSSAPropagationCallGraphBuilder builder = JSCallGraphBuilderUtil.makeCGBuilder(loaders, modules, CGBuilderType.ONE_CFA, AstIRFactory.makeDefaultFactory());
		return builder;
	}
